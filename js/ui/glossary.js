        ...
        subsections: [
            {
                ...
                entries: [
                    ...
                    ['Esc', 'Close panel / exit mode / open Settings.'],
                    ['Q', 'Draft/undraft selected colonist(s).'],
                    ['E', 'Select all colonists.'],
                    ['N', 'Jump to next idle colonist.'],
                    ['Home', 'Center camera on selection.'],
                    ['[ / ]', 'Select previous/next colonist (centers camera).'],
                    ['1-9 (normal)', "Cast selected colonist's spells (targeted)."],
                    ...
                    ['Rebinding', 'Remap keys in Settings → Controls / Keybindings.'],
                ]
            },
            {
