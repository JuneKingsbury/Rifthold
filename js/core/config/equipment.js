...
export const ARTIFACTS = {
    boots_of_haste: { name: 'Boots of Haste', textColor:'#b2ff82', tradeValue: 55, moveSpeedBonus: 0.5, description: 'Enchanted boots that quicken the wearer.', expedition: { durationMult: 0.85 }, recipe: { input: { void_essence: 3, planks: 2, runite: 1 }, ticks: 55, research: 'void_forging', station: 'enchanting_table' } },
    seedkeepers_locket: { name: "Seedkeeper's Locket", textColor:'#b2ff82', tradeValue: 55, description: 'A locket blessed by druids. Protects crops from blight.', pedestal: { radius: 8, manaCost: 1, blightImmunity: true }, expedition: { trapDamageMult: 0.7 } },
    hourglass_of_diligence: { name: 'Hourglass of Diligence', textColor:'#b2ff82', tradeValue: 50, description: 'Time bends around this hourglass, hastening all labor.', workSpeedBonus: 0.25, pedestal: { radius: 5, manaCost: 2, workSpeedBonus: 0.15 } },
    lodestone_of_prosperity: { name: 'Lodestone of Prosperity', textColor:'#b2ff82', tradeValue: 45, description: 'A magnetic stone that draws wanderers and traders to your colony.', pedestal: { radius: 'global', manaCost: 2, wandererChanceMult: 1.25, traderChanceMult: 1.25 } },
    cornucopia_charm: { name: 'Cornucopia Charm', textColor:'#b2ff82', tradeValue: 40, description: 'A charm of abundance. Cooking yields extra food.', pedestal: { radius: 'global', manaCost: 1, cookingBonusFood: 1 } },
    compass_of_greed: { name: 'Compass of Greed', textColor:'#b2ff82', tradeValue: 35, description: 'Points toward treasure, but attracts danger.', expedition: { lootMult: 1.5, trapDamageMult: 1.2 } },
    voidwalkers_lantern: { name: "Voidwalker's Lantern", textColor:'#b2ff82', tradeValue: 45, description: 'A lantern fueled by void energy. Reveals hidden paths.', expedition: { rareEncounterMult: 2.0 }, pedestal: { radius: 6, manaCost: 2, lightRadius: 4 } },
    map_fragment: { name: 'Map Fragment', textColor:'#b2ff82', tradeValue: 25, description: 'A torn piece of an ancient map. Shortens expeditions.', consumable: true, expedition: { durationMult: 0.7 } },
    ward_of_the_sentinel: { name: 'Ward of the Sentinel', textColor:'#b2ff82', tradeValue: 60, description: 'A one-use ward that revives the bearer from death.', combat: { autoReviveHp: 0.5 }, expedition: { autoReviveHp: 0.5 }, durability: { max: 1, breakOnUse: true }, recipe: { input: { void_essence: 4, runite: 3, stone: 2 }, ticks: 65, research: 'void_forging', station: 'enchanting_table' } },
    drum_of_rallying: { name: 'Drum of Rallying', textColor:'#b2ff82', tradeValue: 50, description: 'War drums that inspire nearby fighters.', attackSpeed: 0.15, pedestal: { radius: 8, manaCost: 3, damageBonusMult: 1.15 }, expedition: { partyDamageMult: 1.15 }, recipe: { input: { wood: 6, runite: 2, planks: 3 }, ticks: 45, research: 'runeforging', station: 'enchanting_table' } },
    cloak_of_shadows: { name: 'Cloak of Shadows', textColor:'#b2ff82', tradeValue: 40, description: 'A cloak that makes the wearer harder to target.', combat: { targetPriority: -10 }, expedition: { targetPriority: -10 } },
    aegis_of_the_vanguard: { name: 'Aegis of the Vanguard', textColor:'#b2ff82', tradeValue: 60, description: 'A heavy shield that draws attacks and absorbs blows.', combat: { targetPriority: 10, damageReduction: 0.3 }, expedition: { targetPriority: 10, damageReduction: 0.3 } },
    hagglers_coin: { name: "Haggler's Coin", textColor:'#b2ff82', tradeValue: 40, description: 'A lucky coin that improves trade deals.', pedestal: { radius: 'global', manaCost: 1, tradeMarkupMult: 0.85 } },
    tome_of_shared_wisdom: { name: 'Tome of Shared Wisdom', textColor:'#b2ff82', tradeValue: 50, description: 'A tome that accelerates skill growth for those nearby.', pedestal: { radius: 5, manaCost: 2, skillGrowthBonus: 0.1 } },
    crystal_aegis: { name: 'Crystal Aegis', textColor:'#b2ff82', tradeValue: 45, description: 'A crystalline shield that absorbs damage.', damageReduction: 0.2, combat: { damageReduction: 0.15 }, expedition: { damageReduction: 0.2 } },
    runite_hammer: { name: 'Runite Hammer', textColor:'#b2ff82', tradeValue: 50, description: 'A hammer pulsing with runic energy. Greatly speeds work.', workSpeedBonus: 0.35, pedestal: { radius: 5, manaCost: 2, workSpeedBonus: 0.2 } },
    staff_of_regrowth: { name: 'Staff of Regrowth', textColor:'#b2ff82', tradeValue: 45, description: 'A living staff that protects crops and amplifies spells.', spellDamageBonus: 0.2, pedestal: { radius: 6, manaCost: 2, blightImmunity: true } },
    mycelium_crown: { name: 'Mycelium Crown', textColor:'#b2ff82', tradeValue: 40, description: 'A crown woven from fungal threads. Enhances growth.', workSpeedBonus: 0.15, pedestal: { radius: 5, manaCost: 2, skillGrowthBonus: 0.15 }, expedition: { trapDamageMult: 0.6 } },
    living_bark_armor: { name: 'Living Bark Armor', textColor:'#b2ff82', tradeValue: 55, description: 'Armor grown from a living tree. Regenerates the wearer.', damageReduction: 0.25, healthRegen: 0.07, combat: { damageReduction: 0.2, healthRegen: 0.05 }, expedition: { damageReduction: 0.25, healthRegen: 0.07 } },
    heartwood_staff: { name: 'Heartwood Staff', textColor:'#b2ff82', tradeValue: 55, description: 'A staff carved from ancient heartwood. Strong magic focus.', spellDamageBonus: 0.3, pedestal: { radius: 7, manaCost: 3, skillGrowthBonus: 0.1 } },
    scholars_spectacles: { name: "Scholar's Spectacles", textColor:'#b2ff82', tradeValue: 45, description: 'Enchanted lenses that sharpen the mind.', workSpeedBonus: 0.2, pedestal: { radius: 'global', manaCost: 2, skillGrowthBonus: 0.1 } },
    arcane_amplifier: { name: 'Arcane Amplifier', textColor:'#b2ff82', tradeValue: 55, description: 'A crystal that amplifies all magical output.', spellDamageBonus: 0.35, expedition: { partyDamageMult: 1.1 } },
    staff_of_distortion: { name: 'Staff of Distortion', textColor:'#b2ff82', tradeValue: 60, description: 'A staff that warps space, confusing enemies.', spellDamageBonus: 0.4, combat: { targetPriority: -5 }, expedition: { partyDamageMult: 1.2, trapDamageMult: 1.3 } },
    void_charm: { name: 'Void Charm', textColor:'#b2ff82', tradeValue: 65, description: 'A charm that seems to make your weapons cut through dimensions.', combat: { targetPriority: 5, damageReduction: 0.1 }, expedition: { partyDamageMult: 1.25 } },
    dimensional_orb: { name: 'Dimensional Orb', textColor:'#b2ff82', tradeValue: 70, description: 'An orb that bends space. Shortens journeys dramatically.', expedition: { durationMult: 0.6, rareEncounterMult: 2.5 }, pedestal: { radius: 'global', manaCost: 3, wandererChanceMult: 1.3 } },
    shard_of_oblivion: { name: 'Shard of Oblivion', textColor:'#b2ff82', tradeValue: 65, description: 'A shard of pure destruction. Devastating but dangerous.', expedition: { partyDamageMult: 1.4, trapDamageMult: 1.5 }, combat: { targetPriority: 5 } },
    voidheart: { name: 'Voidheart', textColor:'#b2ff82', tradeValue: 80, description: 'The heart of the void itself. Ultimate arcane power.', spellDamageBonus: 0.5, moveSpeedBonus: 0.2, pedestal: { radius: 'global', manaCost: 4, damageBonusMult: 1.2 } },
    armor_of_the_abyss: { name: 'Armor of the Abyss', textColor:'#b2ff82', tradeValue: 70, description: 'Abyssal armor that draws fire and shrugs off blows.', damageReduction: 0.35, combat: { damageReduction: 0.3, targetPriority: 10 }, expedition: { damageReduction: 0.35 } },
    amulet_of_fortune: { name: 'Amulet of Fortune', textColor:'#b2ff82', tradeValue: 40, description: 'A lucky amulet that accelerates learning.', pedestal: { radius: 'global', manaCost: 1, skillGrowthBonus: 0.2 } },
    merchants_ring: { name: "Merchant's Ring", textColor:'#b2ff82', tradeValue: 35, description: 'A ring favored by traders. Slightly improves deals.', pedestal: { radius: 'global', manaCost: 1, tradeMarkupMult: 0.9 } },
};
