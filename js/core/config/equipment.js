...
export const ARTIFACTS = {
    ...
    void_charm: { name: 'Void Charm', tradeValue: 65, description: 'A charm that seems to make your weapons cut through dimensions.', combat: { targetPriority: 5, damageReduction: 0.1 }, expedition: { partyDamageMult: 1.25 } },
