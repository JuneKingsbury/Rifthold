...
export const WEAPONS = {
    ...
    stone_spear: { name: 'Stone Spear', damage: 7, tier: 1, attackCooldown: 2, critChance: 0.15, attackAnim: 'Stab', description: 'A sharpened stone lashed to a stick. Attacks quickly and precisely, with a chance to land a critical hit.', recipe: { input: { stone: 2, wood: 1 }, ticks: 12 } },
    ...
    void_blade: { name: 'Void Blade', damage: 52, tier: 4, attackCooldown: 5, attackAnim: 'Swing', description: 'A blade forged in the Abyss. It feels heavier than it looks.', recipe: { input: { void_essence: 6, runite: 2, planks: 1 }, ticks: 60, research: 'void_forging', station: 'enchanting_table' } },
};
...
export const TOOLS = {
    stone_pickaxe: { name: 'Stone Pickaxe', miningSpeed: 1.25, tier: 1, description: 'The simplest pickaxe capable of breaking rocks.', recipe: { input: { stone: 2, planks: 1 }, ticks: 14 } },
    iron_pickaxe: { name: 'Iron Pickaxe', miningSpeed: 1.45, tier: 2, description: 'A competent pickaxe that easily breaks stone.', recipe: { input: { iron: 2, planks: 1 }, ticks: 20, research: 'metalworking', station: 'anvil' } },
    runic_pickaxe: { name: 'Runic Pickaxe', miningSpeed: 1.7, tier: 3, description: 'A magically-enhanced pickaxe that helps pulverize boulders.', recipe: { input: { runite: 2, planks: 1 }, ticks: 35, research: 'runeforging', station: 'enchanting_table' } },
    stone_axe: { name: 'Stone Axe', choppingSpeed: 1.25, tier: 1, description: 'The simplest axe capable of chopping wood.', recipe: { input: { stone: 2, planks: 1 }, ticks: 14 } },
    iron_axe: { name: 'Iron Axe', choppingSpeed: 1.45, tier: 2, description: 'A competent axe that easily fells trees.', recipe: { input: { iron: 2, planks: 1 }, ticks: 20, research: 'metalworking', station: 'anvil' } },
    runic_axe: { name: 'Runic Axe', choppingSpeed: 1.7, tier: 3, description: 'A magically-enhanced axe that helps level forests.', recipe: { input: { runite: 2, planks: 1 }, ticks: 35, research: 'runeforging', station: 'enchanting_table' } },
    stone_sickle: { name: 'Stone Sickle', farmingSpeed: 1.25, tier: 1, description: 'The simplest sickle capable of harvesting crops.', recipe: { input: { stone: 1, planks: 1 }, ticks: 12 } },
    iron_sickle: { name: 'Iron Sickle', farmingSpeed: 1.45, tier: 2, description: 'A competent sickle that easily harvests crops.', recipe: { input: { iron: 1, planks: 1 }, ticks: 18, research: 'metalworking', station: 'anvil' } },
    runic_sickle: { name: 'Runic Sickle', farmingSpeed: 1.7, tier: 3, description: 'A magically-enhanced sickle that helps reap entire fields.', recipe: { input: { runite: 1, planks: 1 }, ticks: 30, research: 'runeforging', station: 'enchanting_table' } },
    stone_hammer: { name: 'Stone Hammer', craftingSpeed: 1.25, tier: 1, description: 'The simplest hammer capable of carpentry.', recipe: { input: { stone: 2, planks: 1 }, ticks: 14 } },
    iron_hammer: { name: 'Iron Hammer', craftingSpeed: 1.45, tier: 2, description: 'A competent hammer that easily drives nails through boards.', recipe: { input: { iron: 2, planks: 1 }, ticks: 20, research: 'metalworking', station: 'anvil' } },
    runic_hammer: { name: 'Runic Hammer', craftingSpeed: 1.7, tier: 3, description: 'A magically-enhanced hammer prized by any blacksmith.', recipe: { input: { runite: 2, planks: 1 }, ticks: 35, research: 'runeforging', station: 'enchanting_table' } },
    ...
    crystalline_hammer: { name: 'Crystalline Hammer', textColor: '#4488ff', tradeValue: 50, description: 'A hammer pulsing with crystalline energy. Greatly speeds work.', workSpeedBonus: 0.35, pedestal: { radius: 5, manaCost: 2, workSpeedBonus: 0.2 } },
...
export const TRINKETS = {
    ...
    hourglass_of_diligence: { name: 'Hourglass of Diligence', textColor:'#4488ff', tradeValue: 65, tier: 3, description: 'Time bends around this hourglass, hastening all labor.', workSpeedBonus: 0.25, pedestal: { radius: 5, manaCost: 2, workSpeedBonus: 0.15 }, recipe: { input: { iron: 2, runite: 2, planks: 2 }, ticks: 40, research: 'runeforging', station: 'enchanting_table' } },
    lodestone_of_prosperity: { name: 'Lodestone of Prosperity', textColor:'#44cc44', tradeValue: 50, tier: 3, description: 'A magnetic stone that draws wanderers and traders to your colony.', pedestal: { radius: 'global', manaCost: 2, wandererChanceMult: 1.15, traderChanceMult: 1.15 }, recipe: { input: { iron: 2, runite: 1, planks: 2 }, ticks: 35, research: 'runeforging', station: 'enchanting_table' } },
    cornucopia_charm: { name: 'Cornucopia Charm', textColor:'#44cc44', tradeValue: 48, tier: 2, description: 'A charm of abundance. Cooking yields extra food.', pedestal: { radius: 'global', manaCost: 1, cookingBonusFood: 1 }, recipe: { input: { wheat: 3, berries: 2, planks: 2 }, ticks: 28, research: 'alchemy', station: 'cauldron' } },
    ...
    tome_of_shared_wisdom: { name: 'Tome of Shared Wisdom', textColor:'#4488ff', tradeValue: 65, tier: 3, description: 'A tome that accelerates skill growth for those nearby.', skillGrowthBonus: 0.05, pedestal: { radius: 5, manaCost: 2, skillGrowthBonus: 0.1 }, recipe: { input: { planks: 4, runite: 2, moonbloom: 1 }, ticks: 42, research: 'arcane_studies', station: 'scriptorium' } },
    ...
    iron_clad_effigy: { name: 'Iron-Clad Effigy', textColor:'#cccccc', tradeValue: 28, tier: 1, description: 'A crude iron figurine worn as a ward. Damages enemies that strike the bearer.' , thornsDamage: 3 },
    emberstep_anklet: { name: 'Emberstep Anklet', textColor:'#44cc44', tradeValue: 42, tier: 2, description: 'Warm iron rings that keep the blood moving and the cold at bay.', coldResistance: 0.4, moveSpeedBonus: 0.08 },
    jewelers_loupe: { name: "Jeweler's Loupe", textColor:'#44cc44', tradeValue: 44, tier: 2, description: 'A fine magnifying lens for appraising gems. Its keen focus improves puzzle outcomes and sharpens learning on expeditions.', expedition: { puzzleSuccessBonus: 0.3, xpMult: 1.2 } },
    jesters_bauble: { name: "Jester's Bauble", textColor:'#44cc44', tradeValue: 40, tier: 2, description: 'A shiny, ridiculous trinket that somehow lifts the spirits of everyone nearby.', moodBonus: 8, pedestal: { radius: 5, manaCost: 1, moodBonus: 4 }, recipe: { input: { planks: 2, cloth: 1, iron: 1 }, ticks: 18, station: 'loom' } },
    wanderers_rations_pouch: { name: "Wanderer's Rations Pouch", textColor:'#cccccc', tradeValue: 25, tier: 1, description: 'A pouch of preserved rations that stave off hunger and fatigue on long journeys.', hungerDecayMult: 0.8, expedition: { fatigueMult: 0.85 }, recipe: { input: { leather: 2, planks: 1 }, ticks: 14 } },
    ghost_step_charm: { name: 'Ghost-Step Charm', textColor:'#4488ff', tradeValue: 65, tier: 3, description: 'A charm carved with the rune of evasion. The bearer seems to flicker out of the way at the last moment.', dodgeChance: 0.12, expedition: { dodgeChanceMod: 0.15 } },
    bloodstone_gauntlet: { name: 'Bloodstone Gauntlet', textColor:'#4488ff', tradeValue: 68, tier: 3, description: 'A deep-red gem embedded within a gauntlet, siphoning life back to the bearer.', lifeSteal: 0.12, expedition: { partyDamageMult: 1.05 } },
    rallying_standard: { name: 'Rallying Standard', textColor:'#4488ff', tradeValue: 62, tier: 3, description: 'A tiny battle standard that inspires the party to recover after each fight.', expedition: { rallyChance: 0.25, rallyHeal: 0.12 } },
    expedition_spellbook: { name: 'Expedition Spellbook', textColor:'#4488ff', tradeValue: 66, tier: 3, description: 'A condensed field tome that sharpens spellcraft under pressure.', expedition: { spellDamageMult: 1.3 }, recipe: { input: { runite: 2, planks: 3, moonbloom: 1 }, ticks: 40, research: 'arcane_studies', station: 'scriptorium' } },
