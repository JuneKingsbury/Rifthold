...
export const WEAPONS = {
    ...
    runic_greatsword: { name: 'Runic Greatsword', damage: 45, tier: 4, attackCooldown: 5, attackAnim: 'Swing', description: 'A massive two-handed sword. Slow but devastating.', recipe: { input: { runite: 4, iron: 2, planks: 2 }, ticks: 50, research: 'masterwork', station: 'enchanting_table' } },
