...
/*
Artifact rarity tier textColor based on tradeValue
'#cccccc': <= 30
'#44cc44': 31 - 44
'#4488ff': 45 - 55
'#f944ff': 56 - 64
...
export const TRINKETS = {
    seedkeepers_locket: { name: "Seedkeeper's Locket", textColor:'#4488ff', tradeValue: 55, tier: 3, description: 'A locket blessed by druids. Protects crops from blight.', pedestal: { radius: 8, manaCost: 1, blightImmunity: true }, expedition: { trapDamageMult: 0.7 } },
    hourglass_of_diligence: { name: 'Hourglass of Diligence', textColor:'#4488ff', tradeValue: 50, tier: 3, description: 'Time bends around this hourglass, hastening all labor.', workSpeedBonus: 0.25, pedestal: { radius: 5, manaCost: 2, workSpeedBonus: 0.15 } },
    lodestone_of_prosperity: { name: 'Lodestone of Prosperity', textColor:'#4488ff', tradeValue: 45, tier: 3, description: 'A magnetic stone that draws wanderers and traders to your colony.', pedestal: { radius: 'global', manaCost: 2, wandererChanceMult: 1.25, traderChanceMult: 1.25 } },
    cornucopia_charm: { name: 'Cornucopia Charm', textColor:'#44cc44', tradeValue: 40, tier: 2, description: 'A charm of abundance. Cooking yields extra food.', pedestal: { radius: 'global', manaCost: 1, cookingBonusFood: 1 } },
    compass_of_greed: { name: 'Compass of Greed', textColor:'#44cc44', tradeValue: 35, tier: 2, description: 'Points toward treasure, but attracts danger.', expedition: { lootMult: 1.5, trapDamageMult: 1.2 } },
    voidwalkers_lantern: { name: "Voidwalker's Lantern", textColor:'#4488ff', tradeValue: 45, tier: 3, description: 'A lantern fueled by void energy. Reveals hidden paths.', expedition: { rareEncounterMult: 2.0 }, pedestal: { radius: 6, manaCost: 2, lightRadius: 4 } },
    ...
    ward_of_the_sentinel: { name: 'Ward of the Sentinel', textColor:'#f944ff', tradeValue: 60, tier: 3, description: 'A one-use ward that revives the bearer from death.', autoReviveHp: 0.5, durability: { max: 1, breakOnUse: true }, recipe: { input: { void_essence: 4, runite: 3, stone: 2 }, ticks: 65, research: 'void_forging', station: 'enchanting_table' } },
    hagglers_coin: { name: "Haggler's Coin", textColor:'#44cc44', tradeValue: 40, tier: 2, description: 'A lucky coin that improves trade deals.', pedestal: { radius: 'global', manaCost: 1, tradeMarkupMult: 0.85 } },
    tome_of_shared_wisdom: { name: 'Tome of Shared Wisdom', textColor:'#4488ff', tradeValue: 50, tier: 3, description: 'A tome that accelerates skill growth for those nearby.', pedestal: { radius: 5, manaCost: 2, skillGrowthBonus: 0.1 } },
    arcane_amplifier: { name: 'Arcane Amplifier', textColor:'#4488ff', tradeValue: 55, tier: 3, description: 'A crystal that amplifies all magical output.', spellDamageBonus: 0.35, expedition: { partyDamageMult: 1.1 } },
    void_charm: { name: 'Void Charm', textColor:'#ff4444', tradeValue: 65, tier: 4, description: 'A charm that seems to make your weapons cut through dimensions.', targetPriority: 5, damageReduction: 0.1, expedition: { partyDamageMult: 1.25 } },
    dimensional_orb: { name: 'Dimensional Orb', textColor:'#ff4444', tradeValue: 70, tier: 4, description: 'An orb that bends space. Shortens journeys dramatically.', expedition: { durationMult: 0.6, rareEncounterMult: 2.5 }, pedestal: { radius: 'global', manaCost: 3, wandererChanceMult: 1.3 } },
    shard_of_oblivion: { name: 'Shard of Oblivion', textColor:'#ff4444', tradeValue: 65, tier: 4, description: 'A shard of pure destruction. Devastating but dangerous.', targetPriority: 5, expedition: { partyDamageMult: 1.4, trapDamageMult: 1.5 } },
    voidheart: { name: 'Voidheart', textColor:'#ff4444', tradeValue: 80, tier: 4, description: 'The heart of the void itself. Ultimate arcane power.', spellDamageBonus: 0.5, moveSpeedBonus: 0.2, pedestal: { radius: 'global', manaCost: 4, damageBonusMult: 1.2 } },
    amulet_of_fortune: { name: 'Amulet of Fortune', textColor:'#44cc44', tradeValue: 40, tier: 2, description: 'A lucky amulet that accelerates learning.', pedestal: { radius: 'global', manaCost: 1, skillGrowthBonus: 0.2 } },
    merchants_ring: { name: "Merchant's Ring", textColor:'#44cc44', tradeValue: 35, tier: 2, description: 'A ring favored by traders. Slightly improves deals.', pedestal: { radius: 'global', manaCost: 1, tradeMarkupMult: 0.9 } },
};
