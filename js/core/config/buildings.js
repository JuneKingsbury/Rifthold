...
export const BUILDINGS = {
    ...
    // === Furniture ===
    candle:            { char: 'i', color: '#ffcc00', cost: { wood: 1 }, work: 4, structureType: 'furniture', category: 'Furniture', dragPlace: true, lightRadius: 5, description: 'Light source. Does not provide warmth.' },
    campfire:          { char: '≈', color: '#ff8833', cost: { wood: 3 }, work: 10, structureType: 'furniture', category: 'Furniture', lightRadius: 3, warmRadius: 3, description: 'Provides warmth (radius 3) and light. No mana required.' },
    ...
    food_chest:        { char: 'S', color: '#997744', cost: { planks: 4, stone: 2 }, work: 25, structureType: 'furniture', category: 'Furniture', description: 'Preserves food, reducing spoilage by 15% per chest (stacks up to 60%).' },
    ice_box:           { char: 'I', color: '#88ccff', cost: { runite: 2, stone: 4, planks: 2, void_essence: 2 }, work: 40, structureType: 'furniture', category: 'Furniture', research: 'alchemy', power: { consumes: 1 }, description: 'Magically chills food, reducing spoilage by 40%. Consumes 1 mana.' },
    ...
    anvil:             { char: '⌂', color: '#999999', cost: { stone: 6, bricks: 2, planks: 2 }, work: 30, structureType: 'furniture', category: 'Production', research: 'metalworking', description: 'Required for metalworking. Able to create iron weapons, armor, tools, and even repair broken trinkets.' },
    ...
    forge_core:        { char: '⚒', color: '#ff8844', cost: { stone: 6, runite: 3, planks: 3 }, work: 40, structureType: 'furniture', category: 'Arcane', research: 'masterwork', description: 'Core of the Great Forge. Surround with Ritual Chalk on all sides to activate (2.5x crafting speed & +2 quality bonus colony-wide).' },
