...
export const BUILDINGS = {
    ...
    rug:               { char: '~', color: '#cc6644', bg: '#4a2211', cost: { leather: 2 }, work: 10, structureType: 'furniture', category: 'Furniture', description: 'Decorative rug. Counts as fine flooring for room quality.' },
    ...
    bookcase:          { char: '║', color: '#775533', cost: { planks: 4, leather: 1 }, work: 18, structureType: 'furniture', category: 'Furniture', roomQuality: 7, decorRooms: ['bedroom', 'townhall'], research: 'stonework', description: 'A bookcase. Improves bedroom and Town Hall quality.' },
