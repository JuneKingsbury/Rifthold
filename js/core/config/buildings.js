...
export const BUILDINGS = {
    ...
    campfire:          { char: '≈', color: '#ff8833', cost: { wood: 3 }, work: 10, structureType: 'furniture', category: 'Furniture', lightRadius: 3, warmRadius: 3, smokeEmitter: true, description: 'Provides warmth (radius 3) and light. No mana required.' },
    ...
    cauldron:          { char: 'F', color: '#ff6633', cost: { stone: 3, wood: 1 }, work: 18, structureType: 'furniture', category: 'Production', smokeEmitter: true, description: 'Required for cooking meals from raw food and crops.' },
