...
export const BUILDINGS = {
    ...
    anvil:             { char: '⌂', color: '#999999', cost: { stone: 6, bricks: 2, planks: 2 }, work: 30, structureType: 'furniture', category: 'Production', description: 'Required for metalworking — iron weapons, armor, tools, and trinket repair.' },
