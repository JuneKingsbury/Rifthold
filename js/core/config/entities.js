export const ENTITIES = {
    ...
    chicken: { char: 'c', color: '#ddaa44', hp: 15, speed: 0.15, category: 'animal', hostile: false, meatYield: 1, fleeRange: 3, spawnWeight: 13, lore: 'A bit more wild that their kingdom counterparts. Regardless, they are easy to tame and seem to enjoy the company of people.', tameable: true, tamed: { foodToTame: 2, roles: [{ type: 'production', produces: 'eggs', produceRate: 80, produceAmount: 1 }, { type: 'wander' }], effects: [] } },
    cow:     { char: 'C', color: '#aa7744', hp: 80, speed: 0.11, category: 'animal', hostile: false, meatYield: 4, hideYield: 3, fleeRange: 4, spawnWeight: 13, lore: 'A common bovine found in the fields of the Frontier.', tameable: true, tamed: { foodToTame: 4, roles: [{ type: 'production', produces: 'milk', produceRate: 100, produceAmount: 2 }, { type: 'wander' }], effects: [] } },
    sheep:   { char: 's', color: '#cccccc', hp: 40, speed: 0.14, category: 'animal', hostile: false, meatYield: 2, woolYield: 1, fleeRange: 4, spawnWeight: 13, lore: 'A docile herbivore commonly found in the meadows of the Frontier.', tameable: true, tamed: { foodToTame: 3, roles: [{ type: 'production', produces: 'wool', produceRate: 120, produceAmount: 1 }, { type: 'wander' }], effects: [] } },
