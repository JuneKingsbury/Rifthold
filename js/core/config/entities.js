export const ENTITIES = {
    ...
    crusader:        { name: 'Crusader', char: 'C', color: '#d6d216', hp: 80, speed: 0.32, category: 'enemy', hostile: true, damage: 10, aggroRange: 40, noFlee: true, roles: [{ type: 'melee_charger' }], attackAnim: 'Swing', damageReduction: 0.2, loot: [], lore: '' },
    crusader_archer: { name: 'Crusader Archer', char: 'C', color: '#d6a816', hp: 50, speed: 0.24, category: 'enemy', hostile: true, damage: 4, aggroRange: 40, noFlee: true, roles: [{ type: 'ranged_attacker', range: 7, preferDistance: 5 }], ranged: true, projectileChar: '-', projectileColor: '#d6d216', attackAnim: 'DrawAndShoot', damageReduction: 0.1, loot: [], lore: '' },
