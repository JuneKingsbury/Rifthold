export const ENTITIES = {
    // === Animals ===
    deer:    { char: 'd', color: '#bb8855', hp: 40, speed: 0.22, category: 'animal', hostile: false, meatYield: 3, hideYield: 2, fleeRange: 5, spawnWeight: 15, lore: 'An offshoot of the common mule deer. These skittish creatures are found all throughout the Frontier.', tameable: true, tamed: { foodToTame: 4, roles: [{ type: 'pack', expeditionSpeedBonus: 0.10 }, { type: 'wander' }], effects: [] } },
    rabbit:  { char: 'r', color: '#ccaa88', hp: 10, speed: 0.3, category: 'animal', hostile: false, meatYield: 1, fleeRange: 4, spawnWeight: 12, lore: 'A long eared rodent found in the forests of the Frontier.', tameable: true, tamed: { foodToTame: 1, roles: [{ type: 'wander' }], effects: [{ type: 'mood_aura', scope: 'aura', radius: 3, moodBonus: 2 }] } },
