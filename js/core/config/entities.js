export const ENTITIES = {
    ...
    // === Summons ===
    familiar: { name: 'Familiar', char: 'f', color: '#9966ff', hp: 40, speed: 0.5, category: 'summon', damage: 8, summonDuration: 60, lore: 'TODO', roles: [{ type: 'guard', guardRadius: 6, patrolRadius: 3 }, { type: 'summoned' }] },
    ghost:    { name: 'Ghost',    char: 'g', color: '#88ccff', hp: 25, speed: 0.7, category: 'summon', damage: 14, summonDuration: 80, lore: 'TODO', roles: [{ type: 'guard', guardRadius: 8, patrolRadius: 4 }, { type: 'summoned' }] },
    monster:  { name: 'Monster',  char: 'M', color: '#ff4466', hp: 60, speed: 0.4, category: 'summon', damage: 20, summonDuration: 100, lore: 'TODO', roles: [{ type: 'guard', guardRadius: 10, patrolRadius: 5 }, { type: 'summoned' }] },
    // Weak, short-lived skirmisher conjured in packs by Spectral Swarm.
    spectral_wisp: { name: 'Spectral Wisp', char: 'w', color: '#aaccff', hp: 12, speed: 0.6, category: 'summon', damage: 5, summonDuration: 45, lore: 'TODO', roles: [{ type: 'guard', guardRadius: 7, patrolRadius: 4 }, { type: 'summoned' }] },
    ...
    // === Enemies ===
    raider_brute:    { name: 'Raider', char: 'R', color: '#ff3333', hp: 50, speed: 0.28, category: 'enemy', hostile: true, damage: 5, aggroRange: 30, roles: [{ type: 'melee_charger' }], attackAnim: 'Swing', loot: [], lore: 'TODO' },
    raider_archer:   { name: 'Raider Archer', char: 'R', color: '#ff6633', hp: 35, speed: 0.18, category: 'enemy', hostile: true, damage:2, aggroRange: 30, roles: [{ type: 'ranged_attacker', range: 5, preferDistance: 4 }], ranged: true, projectileChar: '-', projectileColor: '#ffaa33', attackAnim: 'DrawAndShoot', loot: [], lore: 'TODO' },
    crusader:        { name: 'Crusader', char: 'C', color: '#d6d216', hp: 80, speed: 0.32, category: 'enemy', hostile: true, damage: 10, aggroRange: 40, noFlee: true, roles: [{ type: 'melee_charger' }], attackAnim: 'Swing', damageReduction: 0.2, loot: [], lore: 'TODO' },
    crusader_archer: { name: 'Crusader Archer', char: 'C', color: '#d6a816', hp: 50, speed: 0.24, category: 'enemy', hostile: true, damage: 4, aggroRange: 40, noFlee: true, roles: [{ type: 'ranged_attacker', range: 7, preferDistance: 5 }], ranged: true, projectileChar: '-', projectileColor: '#d6d216', attackAnim: 'DrawAndShoot', damageReduction: 0.1, loot: [], lore: 'TODO' },
    raider_hexer:    { name: 'Raider Hexer', char: 'R', color: '#cc44ff', hp: 30, speed: 0.22, category: 'enemy', hostile: true, damage: 1, aggroRange: 30, roles: [{ type: 'ranged_attacker', range: 6, preferDistance: 5 }], ranged: true, projectileChar: '*', projectileColor: '#cc44ff', attackAnim: 'DrawAndShoot', onHit: { effect: 'slow', duration: 50, moveSpeedMalus: -0.5 }, loot: [], lore: 'TODO' },
    raider_poisoner: { name: 'Raider Poisoner', char: 'R', color: '#44cc44', hp: 40, speed: 0.20, category: 'enemy', hostile: true, damage: 2, aggroRange: 30, roles: [{ type: 'ranged_attacker', range: 5, preferDistance: 4 }], ranged: true, projectileChar: '-', projectileColor: '#44cc44', attackAnim: 'DrawAndShoot', onHit: { effect: 'dot', tickDamage: 1, tickInterval: 5, duration: 60 }, loot: [], lore: 'TODO' },
    void_walker:     { name: 'Void Walker', char: 'V', color: '#aa33ff', hp: 30, speed: 0.21, category: 'enemy', hostile: true, damage: 4, roles: [{ type: 'nexus_target' }], attackAnim: 'Swing', loot: [], lore: 'TODO' },
    void_brute:      { name: 'Void Brute', char: 'V', color: '#7722cc', hp: 80, speed: 0.14, category: 'enemy', hostile: true, damage: 10, roles: [{ type: 'nexus_target' }, { type: 'structure_breaker', breakSpeed: 2 }], attackAnim: 'Swing', loot: [], lore: 'TODO' },
