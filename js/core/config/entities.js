export const ENTITIES = {
    ...
    okapi:   { char: 'O', color: '#b3562e', hp: 100, speed: 0.34, category: 'animal', hostile: false, meatYield: 1, fleeRange: 4, spawnWeight: 11, lore: '', tameable: true, tamed: { foodToTame: 5, roles: [{ type: 'pack', expeditionSpeedBonus: 0.25 }, { type: 'wander' }], effects: [] } },
    tapir:   { char: 't', color: '#f2e6e6', hp: 60, speed: 0.11, category: 'animal', hostile: false, meatYield: 1, fleeRange: 4, spawnWeight: 11, lore: '', tameable: true, tamed: { foodToTame: 3, roles: [{ type: 'wander' }], effects: [{ type: 'mood_aura', scope: 'aura', radius: 4, moodBonus: 5 }] } },
